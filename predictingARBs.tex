...
\begin{frame}
 ...
 \vspace{1cm}
 \begin{tabular}{lll}
  Then & $\Longrightarrow$ & \emph{Mandelbug}\\ %TODO ti bonhomme
...
\begin{frame}
 ...
 High PD so we can to not inspect files classified as non ARB-prone.%TODO verifier anglais

 We have to check if caracteristics are similiar before using a classifier for another project.
\end{frame}
